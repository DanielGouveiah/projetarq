...
const Contacts = () => {
  return (
    <section
      ...
      id="contacts">
      <h2 className="text-3xl md:text-5xl font-semibold text-stone-50 col-span-2 md:col-span-2 md:col-start-2 animation">
        Entre em contato
      </h2>
      ...
      <div className=" text-stone-50 col-span-full grid md:grid-cols-4 justify-center gap-y-4 py-6">
        <div className="grid items-center  justify-center xl:grid-cols-2 gap-6 col-start-2 col-span-2 sm:text-start leading-loose text-lg rounded-xl">
          ...
          <div className="grid justify-center row-start-1 xl:row-auto -z-10">
            <img
              src={contactsPhoto}
              alt=""
